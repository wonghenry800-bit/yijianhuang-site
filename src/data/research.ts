  ...
  en: [
    {
      ...
      summary: 'Analyzed how Hong Kong-Macao approved medicines and devices can enter Guangdong hospitals through staged administrative delegation, with recommendations for cross-border healthcare governance.',
    ...
    },
    {
      ...
      summary: 'Compared CUHK-Shenzhen, HKUST(GZ), and University of Macau Hengqin to understand how cross-border universities balance autonomy, accreditation, and mainland integration.',
    ...
    },
    {
      ...
      summary: 'Conducted randomized household interviews and quality inspection for China WVS Wave 8, covering governance attitudes, political trust, values, and survey compliance.',
    ...
    },
    {
      ...
      summary: 'Used Stata regressions and policy text analysis to connect China-US diplomatic and tariff events with trade flows, supply chains, and policy brief recommendations.',
    ...
    },
    {
      ...
      summary: 'Compared Shunde and Hengqin grassroots governance through interviews, focusing on public services, cross-border administration, and local institutional innovation.',
  ...
  cn: [
    {
      ...
      tag: '政策分析',
      imgs: ['/gallery/medicine_1.jpg', '/gallery/medicine_2.png'],
      summary: '研究港澳已批准药械如何通过分阶段行政授权进入广东医院，并提出跨境医疗治理与政策扩展建议。',
    ...
    },
    {
      ...
      tag: '比较研究',
      imgs: ['/gallery/gba_edu_1.jpeg', '/gallery/gba_edu_2.jpeg'],
      summary: '比较港中深、港科大广州与澳门大学横琴校区，分析跨境高校如何平衡学术自主、认证标准与内地融合。',
    ...
    },
    {
      ...
      tag: '实地调研',
      imgs: ['/gallery/survey_1.png', '/gallery/survey_2.png'],
      summary: '参与中国 WVS 第八轮随机入户调查与质检，覆盖治理态度、政治信任、价值观和访谈合规性。',
    ...
    },
    {
      ...
      tag: '计量经济学',
      imgs: ['/gallery/UNDP.png'],
      summary: '使用 Stata 回归和政策文本分析，研究中美外交与关税事件如何影响贸易流、供应链和政策建议。',
    ...
    },
    {
      ...
      tag: '实地调研',
      imgs: ['/gallery/macau-novo-bairro.jpg'],
      summary: '通过访谈比较顺德与横琴基层治理，重点关注公共服务、跨境行政和地方制度创新。',
